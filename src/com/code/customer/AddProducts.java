...
public class AddProducts extends HttpServlet {
	...
	final String UPLOAD_DIRECTORY = "D:/TestingWorkspace/FlatBud/WebContent/products/";
	static int i = 0;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if (ServletFileUpload.isMultipartContent(request)) 
		{
			try 
			{
				...
				try 
				{
					PreparedStatement ps1 = con.prepareStatement("INSERT INTO `product_details`(`category`, `p_name`, `specification`, `file_name`, `base_price`, `city`,`upload_by`) VALUES ('"+category+"','"+p_name+"','"+specification+"','"+FileName+"','"+base_price+"','"+city+"','"+fname+"')");
