...
public class CustomerRegistration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try 
		{
			...
			PreparedStatement ps1 = con.prepareStatement("INSERT INTO `customer_details`(`name`, `address`, `email`, `mobile`, `password`,`user_type`) VALUES ('"+name+"', '"+address+"','"+email+"','"+mobile+"','"+password+"','"+user_type+"')");
