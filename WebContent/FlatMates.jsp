        ...
        <div class="container">
            <div class="align-items-center row">
                ...
                <div class="col-2 col-sm-1 col-md-1 col-lg-7 text-center">
					...
					<h3 align="center"><b>View FlatMate Details</b></h3>
					<hr class="soften" />
							...
							<div class="carousel-inner">
								...
								<tbody>
										<tr class="techSpecRow">
											...
											<th class="techSpecTD2">Tenant Name</th>
								...
								PreparedStatement ps1 = con.prepareStatement("SELECT * FROM `flatmate_details`");
