                ...
                <div class="col-2 col-sm-1 col-md-1 col-lg-7 text-center">
                    ...
                    <nav class="navbar-nav main-menu d-md-none d-sm-none d-xs-none d-lg-block">
                        <ul class="menu-list">
                         ...
                         <!-- <li><a href="CustomerLogin.jsp"><b>Login as Student</b></a></li> -->
                        </ul>
                    </nav>
                </div>
                ...
                <div class="item active" align="center">
                    <form action="AdminLogin" method="post">
                        <table style="width: 100%">
                            <tr>
                                <th>Email ID</th>
                                <td><input type="text" placeholder="Your Email ID" id="username" class="form-control-login" name="username" required></td>
                            </tr>
                            <tr>
                                <th>Password</th>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 footer-widget pl-lg-5 pl-3 mt-sm-5 mt-xs-5 mt-md-0">
                    ...
                    <ul class="mb-3">
                        ...
                        <li class="mb-3">
                            ...
                            <a class="d-inline-block ml-2" href="#">info@roomeet.com</a>
                        </li>
                        <li class="mb-3">
                           <img src="../img/footer-location-icon.png" alt="">
                            <a class="d-inline-block ml-2" href="#">Nashik, Maharashtra</a>
                        </li>
                        <li class="d-flex">
