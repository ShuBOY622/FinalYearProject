...
<body>
    <header class="header-section shadow-none clearfix bg-transparent">
        <div class="container">
			...
			<h3 align="center"><b>Customer Login</b></h3>
					<hr class="soften" />
							...
							<div class="carousel-inner">
								<div class="item active" align="center">
									<form action="FotgetPassword" method="post">
										<table cellpadding="10" cellspacing="10" style="width: 40%" border="1">
											<tr>
												<th>Email ID</th>
											...
											<tr>
												<td colspan="2" align="center"><button type="submit" class="btn btn-success"><b>Forgot Password</b></button></td>
											</tr>
										</table>
									</form>			
								</div>
