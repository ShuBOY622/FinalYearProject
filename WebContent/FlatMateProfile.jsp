        ...
        <div class="container">
            <div class="align-items-center row">
                ...
                <div class="col-2 col-sm-1 col-md-1 col-lg-7 text-center">
					...
					<h3 align="center"><b>FlatMate/Member Profile</b></h3>
					<hr class="soften" />
					<div class="row-fluid" align="center">
						<div id="newProductCar" class="carousel slide">
							<div class="carousel-inner">
								...
								%>
									<form action="FlatMateProfile" method="post" enctype="multipart/form-data">
										<table style="width: 50%;" cellpadding="10" cellspacing="10" align="center" border="1">
											<tr>
												<th>Name</th>
											...
											<tr>
												<th align="right">Profile Photo :&nbsp;&nbsp;</th>
												<td><input type="file" class="form-control" name="file_name" required></td>
											</tr>
											<tr>
												<td colspan="2" align="center"><button type="submit" class="btn btn-success"><b>Update Profile </b></button></td>
											</tr>
											<%} %>
										</table>
									</form>
