			...
			<div class="navbar-inner">
				<div class="container">
					...
					<div class="nav-collapse">
						<jsp:include page="Header/OwnerHeader.jsp"></jsp:include>
					</div>
				</div>
			</div>
		</div>
						...
						<div id="newProductCar" class="carousel slide">
							<div class="carousel-inner">
								...
								<%
									...
									PreparedStatement ps = con.prepareStatement("SELECT * FROM `payment_details` where payment_by='"+email+"'");
								...
								%>
									<form action="FlatMateRegistration" method="post">
										<table style="width: 50%;" align="center" >
											...
											<tr>
												<th>Address</th>
												<td><input type="text" class="form-control" name="address" value="<%=address %>" readonly></td>
											</tr>
											<tr>
												<th>Email ID</th>
											...
											<tr>
												<th>Mobile No</th>
												<td><input type="text" class="form-control" name="mobile" value="<%=mobile %>" readonly></td>
											</tr>
											<tr>
												<th>Password</th>
												<td><input type="password" class="form-control" name="password" value="<%=password %>" readonly></td>
											</tr>
											<tr>
												<th></th>
												<td><button type="submit" class="btn btn-success"><b>Add Member </b></button></td>
											</tr>
										<%}}%>	
										</table>
									</form>
