...
<%
	...
	{
	out.println("<script>alert('Account not Activated yet by Admin ...!')</script>");	
	}
%>
                        ...
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="ForgotPass.jsp" class="forgot-password-link"><b><i>Forgot Password</i></b></a>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
                                    <button type="button" class="btn btn-success">
                                        <a href="CustomerRegistration.jsp" class="create-account-link">Create New Account</a>
                                    </button>
                                </td>
                            </tr>
                        </table>
