...
{
out.println("<script>alert('Customer/Student Account Activated ...!')</script>");	
}
%>
        ...
        <div class="container">
            <div class="align-items-center row">
                ...
                <div class="col-2 col-sm-1 col-md-1 col-lg-7 text-center">
					...
					<h3 align="center"><b>View Customers/Students Details</b></h3>
					<hr class="soften" />
					<div class="row-fluid" align="center">
						<div id="newProductCar" class="carousel slide">
							<div class="carousel-inner">
								<div class="item active" align="center">
								<form class="post_section" action="AccountActivate" method="post">
								<table class="table table-striped" style="width: 70%" border="1px">
								<tbody>
								...
								%>
										<tr class="techSpecRow">
											...
											<%-- <td class="techSpecTD2"><b><%=rs1.getString("status") %></b></td> --%>
											<%if(status.equals("Not Active")){ %>
								              	<td><a href="CustomerLogin?email=<%=rs1.getString("email")%>"><input type="button" name="Turn On" value="Activate" class="btn btn-info"></a></td>
							            	  <%}else{ %>
											  	<td style="background: green;color: white;"><b><%=rs1.getString("status") %></b></td>
												<%
													}
												}
												%>
