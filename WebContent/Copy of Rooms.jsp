...
%>
   <!-- Header section -->
            ...
            <div class="align-items-center row">
                ...
                <div class="col-2 col-sm-1 col-md-1 col-lg-7 text-center">
                    ...
                    <nav class="navbar-nav main-menu d-md-none d-sm-none d-xs-none d-lg-block">
                        <ul class="menu-list">
                            <li><a href="CustomerHome.jsp"><b>Home</b></a></li>
	...
	%>
	<div class="span7-flat">
	<img src="assets/img/room.png" alt="Search Image" class="search-image-flat">
    <h2>Welcome To FlatBud</h2>
    <h3>Search Flat Availability</h3>
    <hr class="soft-flat" />
	<!-- <form action="process.jsp" method="post"> -->
    <div class="control-group-flat">
        <label class="control-label-flat"><b>Check-In Date:</b></label>
        <input type="date" placeholder="Enter Check-In Date" class="form-control-flat" name="check_in_date" required>
    </div>

    <div class="control-group-flat">
        <label class="control-label-flat"><b>Location:</b></label>
        <!-- <input type="text" placeholder="Enter Location" class="form-control-flat" name="location" required> -->
        <select name="sname">
			<option class="form-control-flat" value="">---Select Location From DB----</option>
        <%
    ...
    <!-- </div> -->
    <!-- <div class="control-group-flat" align="center"> -->
        <button type="button" class="btn-flat"> 
            <a href="CustViewProducts.jsp" class="shopBtn-flat"><b style="color:white">Check Availability</b></a>
        </button>
    <!-- </div> -->
    </select>
    		<%
