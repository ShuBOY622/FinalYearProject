                ...
                <div class="col-2 col-sm-1 col-md-1 col-lg-7 text-center">
                    ...
                    <nav class="navbar-nav main-menu d-md-none d-sm-none d-xs-none d-lg-block">
                        <ul class="menu-list">
							...
							<li class=""><a href="ViewFlats.jsp"><b>Available FLats</b></a></li>
							<li class=""><a href="Customers.jsp"><b>Students</b></a></li>
							<li class=""><a href="FlatMates.jsp"><b>FlatMates</b></a></li>
							<li class=""><a href="Owners.jsp"><b>Owners</b></a></li>
        ...
        <div class="container pb-5 pt-5">
            <div class="align-items-center row">
                <div class="col-lg-5 col-xl-5 col-md-6 left-content mt-md-0 mt-sm-4 mt-xs-4 order-md-0 order-sm-1 order-xs-1">
                    <h5 class="font-30 font-weight-bold">Welcome !</h5>
        ...
        <div class="container pt-5">
            ...
            <div class="row mb-5 pt-4">
                <div class="col-md-12 text-center">
                    <h5 class="font-30 font-weight-bold mb-3">Admin Dashboard</h5>
                ...
                <div class="col-md-6 col-lg-4 col-xl-4 mt-4">
                        <div class="card active">
                            <div class="card-body pb-5 pt-5 text-center">
                                <a href="adminHome.jsp"><img class="mt-3" src="assets/img/vflats.png" alt=""></a>
                                <h5 class="dark-black font-16 font-weight-bold mt-4">Admin Home Page</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4 mt-4">
                        <div class="card">
                            <div class="card-body pb-5 pt-5 text-center">
                                <a href="ViewFlats.jsp"><img class="mt-3" src="assets/img/uflat.png" alt=""></a>
                                <h5 class="dark-black font-16 font-weight-bold mt-4">Available FLats</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4 mt-4">
                        <div class="card active">
                            <div class="card-body pb-5 pt-5 text-center">
                                <a href="Customers.jsp"><img class="mt-3" src="assets/img/vflats.png" alt=""></a>
                                <h5 class="dark-black font-16 font-weight-bold mt-4">Students Details</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4 mt-4">
                        <div class="card">
                            <div class="card-body pb-5 pt-5 text-center">
                               <a href="FlatMates.jsp"><img class="mt-3" src="assets/img/pay.png" alt=""></a>
                                <h5 class="dark-black font-16 font-weight-bold mt-4">FlatMates</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4 mt-4">
                        <div class="card">
                            <div class="card-body pb-5 pt-5 text-center">
                                <a href="Owners.jsp"><img class="mt-3" src="assets/img/cust.png" alt=""></a>
                                <h5 class="dark-black font-16 font-weight-bold mt-4">Owners</h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- <div class="col-md-6 col-lg-4 col-xl-4 mt-4">
                        <div class="card">
                            <div class="card-body pb-5 pt-5 text-center">
                                <a href="CustomerRequest.jsp"><img class="mt-3" src="assets/img/custreq.png" alt=""></a>
                                <h5 class="dark-black font-16 font-weight-bold mt-4">Customer Request</h5>
                            </div>
                        </div>
                    </div> -->
                </div>
