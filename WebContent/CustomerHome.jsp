        ...
        <div class="container pb-5 pt-5">
            <div class="align-items-center row">
                <div class="col-lg-5 col-xl-5 col-md-6 left-content mt-md-0 mt-sm-4 mt-xs-4 order-md-0 order-sm-1 order-xs-1">
					...
					<%
						String sql="select * from customer_details where status='Active'";		
						...
						%>
						<div class="item active" align="center">
							<img src="ProfilePic/<%=file_name%>" alt="bootstrap-ring" height="200px" width="200px">
						</div>			
						<%
							int rsl=count%4;
                ...
                <div class="row mb-5 justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4 mt-4">
                        <div class="card active">
                            <div class="card-body pb-5 pt-5 text-center">
                                <a href="#"><img class="mt-3" src="assets/img/roommate.png" alt=""></a>
