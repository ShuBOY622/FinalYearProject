        ...
        <div class="container">
            <div class="align-items-center row">
                ...
                <div class="col-2 col-sm-1 col-md-1 col-lg-7 text-center">
					...
					<h3 align="center"><b>View Customers Requests</b></h3>
					<hr class="soften" />
					<div class="row-fluid" align="center">
						<div id="newProductCar" class="carousel slide">
							<div class="carousel-inner">
								<div class="item active" align="center">
								<table class="table table-striped" style="width: 80%;" border="1">
								<tbody>
										<tr class="techSpecRow">
											...
											<th class="techSpecTD2">Owner Action</th>
								...
								while (rs1.next()) 
								{
									String flatmate_reply = rs1.getString("flatmate_reply");
									i=i+1;	
