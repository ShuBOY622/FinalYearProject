    ...
    <header class="header-section shadow-none clearfix bg-transparent">
        <div class="container">
            <div class="align-items-center row">
				...
				<h3 align="center"><b>Please give your Valuable Reviews</b></h3>
					<hr class="soften" />
									...
									<form action="Feedback" method="post">
										<table class="table table-striped" style="width: 50%" border="1px">
											...
											<tr>
												...
												<label class="stars" for="4_stars"><b>4 stars</b></label> <input
													type="radio" name="stars" id="3_stars" value="4" /> <label
													class="stars" for="3_stars"><b>3 stars</b></label> <input
													type="radio" name="stars" id="2_stars" value="3" /> <label
													class="stars" for="2_stars"><b>2 stars</b></label> <input
													type="radio" name="stars" id="1_stars" value="2" /> <label
													class="stars" for="1_stars"><b>1 star</b></label> <input
											...
											<tr>
												<td colspan="2" align="center"><button type="submit" class="btn btn-success">Submit</button></td>
											</tr>
										</table>
									</form>
								</div>
